...
| **SOA.2.4前台批量模块** | 1.4 | 批量预约单号，自动提交并等待结果，支持异常记录和跳过；兼容SPA页面切换并将工具按钮固定在预约单号输入框右侧。 | [安装](https://raw.gitcode.com/gcw_7DpHPfUr/wanxin-userscripts/raw/main/publish/soaxg/soa-qiantaipiliang.user.js) | [备用](https://raw.githubusercontent.com/xinxinenjoy/wanxin-userscripts/main/publish/soaxg/soa-qiantaipiliang.user.js) |
